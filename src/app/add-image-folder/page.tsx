...
function AddImageFolderContent() {
  ...
  function handleNext() {
    ...
    if (mode === "label") {
      router.push("/label-tool")
    } else {
      router.push("/add-new-model")
    }
  }
    ...
    <main style={{ background: "var(--bg)", minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      >
        ...
        <button
          ...
          onMouseEnter={(e) => { if (folderName) e.currentTarget.style.opacity = "0.85" }}
...
export default function AddImageFolderPage() {
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <AddImageFolderContent />
    </Suspense>
  )
}